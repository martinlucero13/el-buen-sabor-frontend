...
export async function findArticuloManufacturadoWithReceta(id: number, token: string) {
    try {
        const response = await fetch(`${URL_API_BASE}/articulos-manufacturados/withReceta/${id}`, {
            method: "GET",
            headers: {
